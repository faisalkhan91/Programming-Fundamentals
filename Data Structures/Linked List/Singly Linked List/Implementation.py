"""
Implementation of Singly Linked List Data Structure in python. There is not an equivalent datastructure in python that
is built in to be used as a singly linked list.

In Singly Linked List, a node contains memory space to store data, and a pointer pointing to the next node in the list.
"""
