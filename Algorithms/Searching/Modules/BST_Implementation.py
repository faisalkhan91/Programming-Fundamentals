...
# Method to include all the BST operations and run it as a function if needed, this way all these operations can be
...
if __name__ == "__main__":  # This stops running things in other files, i.e. when the file is imported in other file.
    main()
